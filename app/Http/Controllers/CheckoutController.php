    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        DB::transaction(function () use (
            ...
            $order = Order::create([
                ...
                'shipping_address_line_1' => $request->input('shipping.address_line1'),
                'shipping_address_line_2' => $request->input('shipping.address_line2'),
            ...
            if (auth()->check() && $request->boolean('save_address')) {
                Address::updateOrCreate(
                    ...
                    [
                        ...
                        'address_line_1' => $request->input('shipping.address_line1'),
                        'address_line_2' => $request->input('shipping.address_line2'),
