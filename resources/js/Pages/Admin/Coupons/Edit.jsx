    ...
    return (
        <AdminLayout>
            ...
            <nav className="flex items-center gap-2 text-sm text-gray-400 mb-6">
                ...
                <span className="text-gray-700 font-medium font-mono tracking-wider">{coupon.code}</span>
            </nav>

            <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-900">Edit Coupon</h1>
                <p className="text-sm text-gray-500 mt-0.5">
                    Updating <span className="font-mono font-semibold text-gray-700">{coupon.code}</span>
                        ...
                        <SectionCard title="Usage Stats">
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <span className="text-xs font-medium text-gray-400 uppercase tracking-wide">Times Used</span>
