...
import {
    StatusBadge, StockBadge, StarRating, InfoRow,
    SectionCard, PrimaryButton, SecondaryButton, DangerButton, ConfirmModal,
} from '@/Components';
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                    <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900 truncate max-w-lg">{product.name}</h1>
                    ...
                    <div className="flex items-center gap-3">
                        <SecondaryButton onClick={() => router.visit(route('vendor.products.edit', product.id))}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        {product.low_stock_threshold && (
                                            <span className="text-xs text-gray-400">
                                                · Alert below {product.low_stock_threshold}
                                            </span>
                                        )}
                                    </div>
                        ...
                        <SectionCard
                            ...
                            description={`${product.reviews?.length ?? 0} approved reviews`}
                            action={
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <div className="w-full bg-gray-100 rounded-full h-1.5">
                                <div
                                    ...
                                    style={{
                                        width: `${Math.min(
                                            (product.stock_quantity / Math.max(product.stock_quantity, 100)) * 100,
                                            100
                                        )}%`,
                                    }}
                                />
                            ...
                            <SectionCard title="SEO Preview">
                                <div className="p-3 bg-gray-50 rounded-lg border border-gray-100">
                                    <p className="text-xs text-green-700 mb-0.5">
                                        shopstack.com/product/{product.slug}
                                    </p>
                        ...
                        <div className="flex flex-col gap-3">
                            <PrimaryButton
                                onClick={() => router.visit(route('vendor.products.edit', product.id))}
                                className="w-full justify-center"
                            >
                                Edit Product
                            </PrimaryButton>
                            <SecondaryButton
                                onClick={() => router.visit(route('vendor.products.index'))}
                                className="w-full justify-center"
                            >
                                Back to Products
                            </SecondaryButton>
